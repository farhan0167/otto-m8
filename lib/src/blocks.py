...
# Example execution dictionary
execution = {
    "input": [
        {
            "name": "image", 
            "block_type": "input", 
            "connections": ["process.object_detection", "process.ocr_engine"],
            #"connections": ["process.object_detection"],
            "payload": "image.jpg"
    ...
    "process": [
        {
            ...
            "block_type": "process", 
            "connections": ["output.model_output"],
            "run_config": {
...
def validate_execution(execution_data: dict) -> Union[WorkflowTemplate, ValidationError]:
    try:
        return WorkflowTemplate(**execution_data)
    except ValidationError as e:
        return e

# Validate the execution
#validation_result = validate_execution(execution)
