...
import { FetchTaskRegistry } from '../../../utils/workflow/get_task_registry';
              ...
              <Grid item xs={9}>
                <Box sx={{ display: 'flex', marginTop: '10px', marginBottom: '20px' }}>
                  <Stack variant="outlined" aria-label="Loading button group" direction="row" spacing={1} sx={{height: '40px'}}>
                      <Button id='add-block-button' color='primary' variant='contained' sx={{width: '120px'}} onClick={addNodeButtonClick} size='small'>Add Block</Button>
                      <Button color='primary' variant='contained' sx={{width: '160px'}} onClick={handleShowTestWorkflow} size='small'>Test Workflow</Button>
                      <Button color='primary' variant='contained' sx={{width: '120px'}} onClick={handleRunWorkflowButton} size='small'>Deploy</Button>
