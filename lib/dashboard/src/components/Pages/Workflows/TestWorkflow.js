...
import { useInputHandlerHooks, useInputHandlerPreviewHooks, useUploadFileNameHooks} from '../../../hooks/input_handlers'
...
export const TestWorkflow = ({
    ...
    const { uploadFilePreview, setUploadFilePreview} = useInputHandlerPreviewHooks();
    ...
    const handleCloseTestWorkflowModal = () => {
        setUploadFileName([])
  ...
  return (
    <>
        <Modal 
        show={show} onHide={handleCloseTestWorkflowModal}
        size="xl"
