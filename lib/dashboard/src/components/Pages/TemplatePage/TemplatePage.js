            ...
            {data.map((item) => (
              ...
              >
                ...
                <TableCell>
                    <Tooltip>
                        <IconButton>
                          <RxActivityLog size={20} title='Open Tracer'className='template-action' onClick={() => openTracer(item)}/>
                        </IconButton> 
                    </Tooltip>
                </TableCell>
                <TableCell>
                    {
                      ...
                      <Tooltip>
                          <IconButton>
                            <CiPause1 size={20} title='Stop Template' className='template-action' onClick={() => pauseWorkflow(item)}/>  
                          </IconButton> 
                      </Tooltip>
                      :
                      <Tooltip>
                          <IconButton>
                            <FaPlay size={20} title='Run Template' className='template-action' onClick={() => resumeWorkflow(item)}/>
                          </IconButton> 
                      </Tooltip> 
                    }
                    <Tooltip>
                    ...
                    <Tooltip>
                        <IconButton>
                          <MdDelete size={20} title='Delete Template' className='template-action' onClick={() => deleteWorkflow(item)}/>
                        </IconButton> 
                    </Tooltip>
                </TableCell>
              </TableRow>
