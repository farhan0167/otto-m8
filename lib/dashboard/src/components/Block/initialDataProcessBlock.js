...
import { initialDataCustomBlock } from "./CustomBlock/initialData";
...
export const initialDataProcessBlock = (
    ...
    if (reference_core_block_type === 'custom_block') {
        return initialDataCustomBlock(nodeType, core_block_type, block_code, process_type)
    }
}