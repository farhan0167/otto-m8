        ...
        >
            ...
            <div>
                ...
                <div className='process-block-body'>
                    ...
                    {data.core_block_type === 'hugging_face_model_card' && <HuggingFaceBlockUI data={data}/>}
                    {data.core_block_type === 'hugging_face_multimodal' && <HuggingFaceMultimodalBlockUI data={data}/>}
                    {data.core_block_type === 'openai_chat' && <OpenAIBlockUI data={data}/>}
                    {data.core_block_type === 'http_post_request' && <HTTPPostBlockUI data={data}/>}
                    {data.core_block_type === 'lambda_function' && <LambdaBlockUI data={data}/>}
                    {data.core_block_type === 'ollama_server_chat' && <OllamaChatBlockUI data={data}/>}
                </div>
            </div>
