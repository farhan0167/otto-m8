...
import HTTPPostSideBarData from './HTTP/POST/sideBarData';
            ...
            {({ values, errors, touched, handleChange, handleBlur, handleSubmit, isSubmitting, setFieldValue }) => (
                <Form onSubmit={handleSubmit}>
                    ...
                    {!values.integrated_with && (
                        <Button onClick={() => setFieldValue("integrated_with", {})}>Add a Connection</Button>
                    )}
                    {values.integrated_with && (
                        <ToolConnectComponent integrated_with={values.integrated_with}/>
                    )}
                    <hr/>
...
const ToolConnectComponent = ({integrated_with}) => {
