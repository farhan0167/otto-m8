        ...
        {blockDataConfig && (
            ...
            <div>
              ...
              <Form style={{marginTop: '10px'}}>
                ...
                {blockDataConfig.reference_core_block_type === "hugging_face_model_card" && (
                    <HuggingFaceModelCarSideBarData sideBarData={blockDataConfig} onDataChange={onDataChange} />
                )}

                {/* Hugging Face Multimodal Block Config */}
                {blockDataConfig.reference_core_block_type === "hugging_face_multimodal" && (
                ...
                {blockDataConfig.reference_core_block_type === "ollama_server_generate" && (
                ...
                {/* Ollama Server Generate Block Config */}
                {blockDataConfig.reference_core_block_type === "ollama_server_chat" && (
                ...
                {blockDataConfig.reference_core_block_type === "openai_chat" && (
                ...
                {blockDataConfig.reference_core_block_type === "http_post_request" && (
                    <HTTPPostSideBarData 
                      sideBarData={blockDataConfig} 
                      onDataChange={onDataChange} 
                    />
                )}
                {blockDataConfig.reference_core_block_type === "lambda_function" && (
