                ...
                blockMetadata.process_type === 'custom' ? (
                  <ListGroup.Item 
                    ...
                    style={{
                      ...
                      alignItems: 'center', paddingTop: '2px', paddingBottom: '2px'
                    }}
                    >
                      ...
                      <Tooltip>
                        <MuiButton 
                        sx={{minWidth: '40px', width: '45px', padding: '0px'}}
                        onClick={(e) => onDeleteCustomBlock(blockMetadata, vendorName, blockName)}>
                          <MdDelete size={18}/>
                        </MuiButton>
                      </Tooltip>
                  </ListGroup.Item>
